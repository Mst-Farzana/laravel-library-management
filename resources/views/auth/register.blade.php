<x-guest-layout>
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-gray-600 mt-2">Join CatalogPro and start your freelance journey</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name"
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition @error('name') border-red-500 @enderror"
...
<div class="flex items-start">
    <input id="terms" name="terms" type="checkbox" required
        class="h-4 w-4 mt-1 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500">
    <label for="terms" class="ml-2 block text-sm text-gray-600">
        I agree to the <a href="#" class="text-emerald-600 hover:text-emerald-700 underline">Terms of Service</a> and <a href="#" class="text-emerald-600 hover:text-emerald-700 underline">Privacy Policy</a>
    </label>
</div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-emerald-600 transition">
                Already have an account? <span class="font-semibold text-emerald-600">Sign in</span>
            </a>
        </div>
    </form>
