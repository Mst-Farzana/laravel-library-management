...
<div class="min-h-screen bg-gradient-to-b from-white via-emerald-50/40 to-white dark:from-gray-900 dark:via-gray-800/50 dark:to-gray-900 transition-colors duration-500">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div class="mb-8 animate-fade-in">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-2">Fill in the details below to add a new book to the library collection.</p>
        </div>
            ...
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="published_year" required min="1000" max="{{ date('Y') }}" value="{{ old('published_year') }}"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="total_copies" required min="1" value="{{ old('total_copies', 1) }}"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                            placeholder="5">
                        @error('total_copies')
                            <p class="text-red-500 dark:text-red-400 text-xs mt-1.5 flex items-center gap-1">
                    ...
                    <div>
                        ...
                        <input type="number" name="available_copies" required min="0" value="{{ old('available_copies', 1) }}"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                            placeholder="5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        ...
                        placeholder="Brief description about the book...">{{ old('description') }}</textarea>
                </div>
